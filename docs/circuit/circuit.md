...
Three LEDs, green, yellow, and red, on a breadboard have their cathodes
connected to pins D10, D11, and D12 and their anodes to GND.
...
to the cathode of the green LED. The voltage is reduced from 5V to
...
The Raspberry Pi grabs the state of the green LED from its cathode on the
